    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger as-child>
          ...
          >
            <Icon icon="mdi:table" class="h-4 w-4 mr-2" />
            Insert Table
          </Button>
        </TooltipTrigger>
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger as-child>
            ...
            >
              <Icon icon="mdi:table-column-plus-before" class="h-5 w-5" />
            </Button>
          </TooltipTrigger>
        ...
        <Tooltip>
          <TooltipTrigger as-child>
            ...
            >
              <Icon icon="mdi:table-column-plus-after" class="h-5 w-5" />
            </Button>
          </TooltipTrigger>
        ...
        <Tooltip>
          <TooltipTrigger as-child>
            ...
            >
              <Icon icon="mdi:table-column-remove" class="h-5 w-5" />
            </Button>
          </TooltipTrigger>
        ...
        <Tooltip>
          <TooltipTrigger as-child>
            ...
            >
              <Icon icon="mdi:table-row-plus-before" class="h-5 w-5" />
            </Button>
          </TooltipTrigger>
        ...
        <Tooltip>
          <TooltipTrigger as-child>
            ...
            >
              <Icon icon="mdi:table-row-plus-after" class="h-5 w-5" />
            </Button>
          </TooltipTrigger>
        ...
        <Tooltip>
          <TooltipTrigger as-child>
            ...
            >
              <Icon icon="mdi:table-row-remove" class="h-5 w-5" />
            </Button>
          </TooltipTrigger>
        ...
        <Tooltip>
          <TooltipTrigger as-child>
            ...
            >
              <Icon icon="mdi:format-header-pound" class="h-5 w-5" />
            </Button>
          </TooltipTrigger>
        ...
        <Tooltip>
          <TooltipTrigger as-child>
            ...
            >
              <Icon icon="mdi:table-merge-cells" class="h-5 w-5" />
            </Button>
          </TooltipTrigger>
        ...
        <Tooltip>
          <TooltipTrigger as-child>
            ...
            >
              <Icon icon="mdi:table-remove" class="h-5 w-5" />
            </Button>
          </TooltipTrigger>
