<template>
    <div class="flex flex-col">
        ...
        <!-- Wrapper -->
        <div class="w-full   border rounded-lg h-full overflow-hidden" :class="[
            error
            ...
            <!-- Image button -->
            <button type="button" @click="open" class="w-full h-32 flex items-center justify-center overflow-hidden
