    ...
    <div class="flex items-center gap-2 px-2 py-1">
        <DropdownMenu>
            <DropdownMenuTrigger as-child>
                ...
                <Button :active="active" :icon="current.icon" />
            </DropdownMenuTrigger>
            <DropdownMenuContent class="w-40">
                <DropdownMenuLabel>Lists</DropdownMenuLabel>
                <DropdownMenuSeparator />
                <DropdownMenuRadioGroup v-model="selectedList">
                    <DropdownMenuRadioItem v-for="item in lists" :key="item.value" :value="item.value"
...
const lists = [
    { label: "Bullet", icon: "material-symbols:format-list-bulleted", value: "bulletList" },
    { label: "Ordered", icon: "material-symbols:format-list-numbered", value: "orderedList" },
];
